...
bool Canvas::startup() {
	...
	if (app->hud->startup()) {
		...
		this->imgPageUP_Icon = app->loadDataImage("pageUP_Icon.bmp", true);
		this->imgPageDOWN_Icon = app->loadDataImage("pageDOWN_Icon.bmp", true);
		this->imgPageOK_Icon = app->loadDataImage("pageOK_Icon.bmp", true);
		...
		{
			this->imgBootL = app->loadDataImage("bootL.bmp", true);
			this->imgBootR = app->loadDataImage("bootR.bmp", true);
