...
#ifdef __aarch64__
static constexpr const char* dir = "/switch/doom2rpg/DoomRPG.app";
#elif __3DS__
static constexpr const char* dir = "/3ds/doom2rpg/DoomRPG.app";
#endif
...
public:
    ...
    int getFileSize();
	bool loadDataFile(const char* fileName, int loadType);
	bool loadDataResource(const char* fileName);
